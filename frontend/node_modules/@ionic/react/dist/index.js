...
const IonBreadcrumb = /*@__PURE__*/ createReactComponent('ion-breadcrumb', undefined, undefined, ionBreadcrumb_js.defineCustomElement);
...
const IonActionSheet = /*@__PURE__*/ createOverlayComponent('ion-action-sheet', actionSheetController, ionActionSheet_js.IonActionSheet);
...
const createInlineOverlayComponent = (tagName, customElement) => {
    ...
    const ReactComponent = class extends React__default["default"].Component {
        ...
        render() {
             ...
             */
            return React__default["default"].createElement(tagName, newProps, (this.state.isOpen) ?
...
const IonModal = /*@__PURE__*/ createInlineOverlayComponent('ion-modal', ionModal_js.IonModal);

const IonPopover = /*@__PURE__*/ createInlineOverlayComponent('ion-popover', ionPopover_js.IonPopover);
    ...
    React.useEffect(() => {
        if (isOpen && component && containerElRef.current) {
            if (React__default["default"].isValidElement(component)) {
                ...
                const element = React__default["default"].createElement(component, componentProps);
